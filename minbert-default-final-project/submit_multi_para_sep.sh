#!/bin/bash
#SBATCH --job-name=sophia_para_sep_optimal_hyparm
...
# Run the script:
python -u multitask_classifier.py --use_gpu --option finetune  --optimizer "sophiag" --epochs 5 --para_sep True --hidden_dropout_prob_sst 0.3 --hidden_dropout_prob_sts 0.3
