#!/bin/bash
#SBATCH --job-name=sophia_add_onelayers_loss_weights_para_sep
...
#SBATCH --mail-user=finn.schmidt@stud.uni-goettingen.de # TODO: change this to your mailaddress!
...
# Run the script:
python -u multitask_classifier.py --use_gpu --option finetune  --optimizer "sophiag" --epochs 5 --para_sep True --add_layers True --weights True --hidden_dropout_prob_sst 0.3 --hidden_dropout_prob_sts 0.3
