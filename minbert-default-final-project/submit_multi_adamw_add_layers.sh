#!/bin/bash
#SBATCH --job-name=adam_add_layer_relu
...
# Run the script:
python -u multitask_classifier.py --use_gpu --option finetune  --optimizer "adamw" --epochs 10 --one_embed True  --add_layers True --comment adam_add_layers_one_embed
