#!/bin/bash
#SBATCH --job-name=sophia_loss_weights_para_sep
...
# Run the script:
python -u multitask_classifier.py --use_gpu --option finetune  --optimizer "sophiag" --epochs 5 --weights True --para_sep True --hidden_dropout_prob_sst 0.3 --hidden_dropout_prob_sts 0.3
