#!/bin/bash
#SBATCH --job-name=multi-smart-opt
...
# Run the script:
python -u multitask_classifier.py --use_gpu --option finetune --lr 1e-5 --optimizer "adamw" --epochs 20 --comment "_smart" --batch_size 32 --smart --multi_smart
